...
<script type="text/javascript">
    function createItem() {
        ...
        fetch(`${apiBaseURL}/admin/api/thongtintour/create.php`, {
            method: 'POST',
            headers: {
    ...
    function updateItem() {
        ...
        fetch(`${apiBaseURL}/admin/api/thongtintour/update.php`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    function performDelete(id) {
        ...
        fetch(`${apiBaseURL}/admin/api/thongtintour/delete.php`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        function openDetail(id) {
            fetch(`${apiBaseURL}/admin/api/thongtintour/show.php?id=` + id, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
        ...
        function fetchDataByPage() {
            ...
            fetch(`${apiBaseURL}/admin/api/thongtintour/readbypage.php?trang=${currentPage}&sp_tungtrang=${itemsPerPage}&search=${searchInput}&tourfilter=<?php echo $_GET['tour']; ?>`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
        ...
        function displayDataInTable(data) {
            ...
            data.data.forEach(item => {
                ...
                document.getElementById('h3-title').innerHTML = 'Thông tin thuộc tour: ' + data.thuoctieude;
