...
class danhmucapi{
	...
	public function read(){
		$query = "SELECT * FROM danhmuc where kieuhienthi='2' and hienthi='0'";
	...
	public function readbypage() {
	    ...
	    $countQuery = "SELECT COUNT(*) as total FROM danhmuc WHERE kieuhienthi = '2' AND hienthi=:hienthi";
	    ...
	    $query = "SELECT * FROM danhmuc WHERE kieuhienthi = '2' AND hienthi=:hienthi";
