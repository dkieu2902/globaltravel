...
class thongtintourapi{
	...
	public function readbypage() {
	    ...
	    $countQuery = "SELECT COUNT(*) as total FROM thongtintour WHERE 1=1";
	    ...
	    $query = "SELECT * FROM thongtintour WHERE 1=1";
	...
	public function show(){
		$query = "SELECT * FROM thongtintour where id=? limit 1";
		$stmt = $this->conn->prepare($query);
	...
	public function create(){
		$query = "INSERT INTO thongtintour SET tieude=:tieude, noidung=:noidung, thutu=:thutu, tour=:tour";
		$stmt = $this->conn->prepare($query);
	...
	public function update(){
		$query = "UPDATE thongtintour SET tieude=:tieude, noidung=:noidung, thutu=:thutu where id=:id";
		$stmt = $this->conn->prepare($query);
	...
	public function delete(){
		$query = "DELETE FROM thongtintour 
		WHERE id=:id";
		$stmt = $this->conn->prepare($query);
