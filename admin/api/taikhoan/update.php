...
if ($data) {
    $taikhoanapi->tennd = $data->tennd;
    $taikhoanapi->username = $data->username;
    $taikhoanapi->password = $data->password;
    $taikhoanapi->ngaysinh = $data->ngaysinh;
    $taikhoanapi->gioitinh = $data->gioitinh;
    $taikhoanapi->email = $data->email;
    $taikhoanapi->phanquyen = $data->phanquyen;
    $taikhoanapi->hienthi = $data->hienthi;
    $taikhoanapi->sdt = $data->sdt;
    $taikhoanapi->diachi = $data->diachi;
