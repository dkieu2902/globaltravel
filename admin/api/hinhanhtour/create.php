...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_FILES['hinhanh']['name'])) {
        ...
        $unique_image = substr(md5($file_name . time()), 0, 10) . '_anhphong.' . $file_ext;
    ...
    $hinhanhtourapi->hinhanh = $_POST['hinhanh'];
    $hinhanhtourapi->tour = $_POST['tour'];

    if ($hinhanhtourapi->create()) {
