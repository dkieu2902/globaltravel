...
<div class="card shadow border-0 mb-7">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2" style="padding: 4px 10px 0 0;">                           
                            <select id="filterDuyet" onchange="changeDuyetFilter()">
    ...
    <div class="modal-bodyy">
        <form class="form-group row" enctype="multipart/form-data" id="myForm">
                    ...
                    value="0">
                        ...
                        <label class="col-sm-2 col-form-label">Thời gian đăng:</label>
                        <div class="col-sm-4">
                         <input type="datetime-local" id="thoigian" class="form-control">
                        </div>  
                    ...
                    <div class="col-sm-8">
                     <textarea id="mota" rows="4" cols="80" class="form-control"></textarea>
                    </div>
  ...
  <div class="modaladd">
    ...
    <div class="modal-bodyy">
        <form class="form-group row" enctype="multipart/form-data">
                    ...
                    <label class="col-sm-2 col-form-label">Slider:</label>
                    <div class="col-sm-4">
                     <img src="" width="70" height="50" id="hienthislider">
                        <input type="file" id="slider_update" />
                    </div> 
...
<script type="text/javascript">
    ...
    function createItem() {
	    ...
	    // Kiểm tra xem có file ảnh được chọn hay không
            ...
            formData.append('duyet', <?php if(Session::get('phanquyen')=='0'){
                            echo '0';
                            }else{
                            echo '1';
                            }
    ...
    function updateItem() {
	    ...
	    var hinhanhFile = hinhanhInput.files[0];
        var sliderInput = document.getElementById('slider_update');
        var sliderFile = sliderInput.files[0];
    ...
    function updateAcceptBefore(madm, duyet) {
        var formData = {
            duyet: duyet,
            id: madm,
        };

        fetch(`${apiBaseURL}/admin/api/tintuc/acceptblog.php`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    function performDelete(id) {
        ...
        function openDetail(id) {
            ...
            .then(data => {
                ...
                document.getElementById('hienthislider').src = `uploads/${data.slider}`;
        ...
        var filterduyet = document.getElementById('filterDuyet').value;

        function changeDuyetFilter() {
            filterduyet = document.getElementById('filterDuyet').value;
            fetchDataByPage();
        }
        ...
        function fetchDataByPage() {
            ...
            <?php if(Session::get('phanquyen')=='0'){
                     ?>
            fetch(`${apiBaseURL}/admin/api/tintuc/readbypage.php?trang=${currentPage}&sp_tungtrang=${itemsPerPage}&hienthi=${selectedHienthi}&search=${searchInput}&filterdanhmuc=${filterdanhmuc}&filterduyet=${filterduyet}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            .catch(error => {
                ...
                tableBody.innerHTML = '<p style="text-align:center;">Không có dữ liệu</p>';
                 ...
                 <?php }else{
                  ...
                  ?>
            fetch(`${apiBaseURL}/admin/api/tintuc/readbyuser.php?trang=${currentPage}&sp_tungtrang=${itemsPerPage}&hienthi=${selectedHienthi}&search=${searchInput}&filterdanhmuc=${filterdanhmuc}&filterduyet=${filterduyet}&nguoidang=<?php echo Session::get('id') ?>`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
        ...
        function displayDataInTable(data) {
		    ...
		    data.data.forEach(item => {
                ...
                cell5.innerHTML = item.tennd;
                <?php if(Session::get('phanquyen')=='0'){
                     ?>
                cell6.innerHTML = item.duyet == '0' ? '<span class="badge badge-lg badge-dot" onclick="updateAccept(\'' + item.id + '\', 1)" style="cursor:pointer;">' +
                        '<i class="bg-success"></i>Đã duyệt' +
                    '</span>' : '<span class="badge badge-lg badge-dot" onclick="updateAccept(\'' + item.id + '\', 0)" style="cursor:pointer;">' +
                        '<i class="bg-danger"></i>Chưa duyệt' +
                    '</span>';
                    cell6.style.textAlign="center";                         
                 <?php }else{

                  ?>
                cell6.innerHTML = item.duyet == '0' ? '<span class="badge badge-lg badge-dot">' +
                        '<i class="bg-success"></i>Đã duyệt' +
