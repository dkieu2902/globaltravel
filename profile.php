<?php
    $title='GlobalTravel - Thông tin tài khoản';
    $description = 'GlobalTravel - Thông tin tài khoản của bạn';
    $keywords = 'GlobalTravel - Thông tin tài khoản';
    $duongdan='/thong-tin-thanh-vien';
      ...
      <form action="" method="POST">
        ...
        <div class="user-details">
          <div class="input-box">
            ...
            <input type="text" name="ten" placeholder="Nhập tên của bạn" value="<?php echo $result[('tennd')] ?>" required>
          </div>
          <div class="input-box">
