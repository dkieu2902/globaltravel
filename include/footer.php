...
.coccoc-alo-ph-img-circle {
    ...
    left: 64px;
    position: absolute;
    background: rgba(30, 30, 30, 0.1) url('images/phoneicon.png') no-repeat center center;
    -webkit-border-radius: 100%;
    -moz-border-radius: 100%;
    border-radius: 100%;
    border: 2px solid transparent;
...
<div class="footer">
            <div class="container">     
                <div class="row">                       
                    <div class="col-lg-3 show-4footer">
                ...
                ?>
                    <div class="col-lg-3 show-4footer">
                        <div class="single_footer single_footer_address">
                            <h4>Về chúng tôi</h4>
                            <ul>
                                <li><a href="/" title="Du lịch Alex"><i class="bi bi-geo-alt"></i> GlobalTravel </a></li>
                                <li><a href="#" title="Liên hệ"><i class="bi bi-telephone"></i> <?php echo $result['hotline'] ?></a></li>
                                <li><a href="#" title="Liên hệ"><i class="bi bi-envelope"></i> <?php echo $result['email'] ?></a></li>
                                <li><a href="lien-he" title="Liên hệ"><i class="bi bi-send"></i> Liên hệ</a></li>
                            </ul>
                        </div>
                    </div><!--- END COL -->
                    <div class="col-lg-3 show-4footer">
                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <p class="copyright">Copyright © 2025 <a href="/" title="Bvico">GlobalTravel</a>.</p>
                    </div><!--- END COL -->                 
                </div><!--- END ROW -->                 
            </div><!--- END CONTAINER -->
        </div>
    ...
    <ul>
        <?php 
                ...
                ?>
        <li><a href="tel:<?php echo $result['hotline']?>" title="Liên hệ số điện thoại"><div class="wrapper">
    <div class="ring">
...
$('.tintuc-slider').slick({
  ...
  autoplaySpeed:5000,
  arrows:true,
  prevArrow:"<button type='button' class='slick-prev pull-left' aria-label='Nút chuyển trước'><i class='fa fa-angle-left' style='color:#000;' aria-hidden='true'></i></button>",
  nextArrow:"<button type='button' class='slick-next pull-right' aria-label='Nút chuyển sau'><i class='fa fa-angle-right' style='color:#000;' aria-hidden='true'></i></button>",
    responsive: [
    {
      breakpoint: 1068,
      settings: {
...
$('.header-tintuc').slick({
  ...
  autoplaySpeed:5000,
  arrows:true,
  prevArrow:"<button type='button' class='slick-prev pull-left' aria-label='Nút chuyển trước'><i class='fa fa-angle-left' style='color:black;' aria-hidden='true'></i></button>",
  nextArrow:"<button type='button' class='slick-next pull-right' aria-label='Nút chuyển sau'><i class='fa fa-angle-right' aria-hidden='true'></i></button>",
    responsive: [
    {
      breakpoint: 1068,
      settings: {
...
const buyField = document.querySelector(".buyfield");
...
buyField.addEventListener("keydown", (event) => {
  if (event.keyCode === 38) {
    buyField.stepUp();
