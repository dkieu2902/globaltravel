...
<link rel="canonical" href="http://localhost/globaltravel<?php echo $duongdan; ?>">

<!-- dublin core -->
<link rel="schema.DC" href="http://purl.org/dc/elements/1.1/">
<meta name="DC.title" content="<?php echo $title; ?>">
<meta name="DC.identifier" content="http://localhost/globaltravel<?php echo $duongdan; ?>">
...
<meta property="og:url" content="http://localhost/globaltravel<?php echo $duongdan; ?>">
...
<link href="http://localhost/globaltravel/css/style.css?v=1.1" rel="stylesheet" type="text/css"/>
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js"></script>
<script src="http://localhost/globaltravel/js/script.js?v=1.3" type="text/javascript"></script>
...
<body>
    <div class="container-fluid" id="scroll-nav" style="background-color: #14304F;">
        <div class="row">
            <div class="col-2">                
            </div>
            <div class="col-8">
                ...
                <?php
                    ...
                    if($login_check==false){
                      ...
                      <div class="taikhoan-top">
                          <div class="dropdown">
                          <button onclick="myFunction1()" class="dropbtn1" class="text-white"><?php echo $name; ?> <i class="bi bi-person"></i></button>
